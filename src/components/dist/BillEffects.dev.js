...
/*#__PURE__*/
function () {
  function BillEffects() {
    _classCallCheck(this, BillEffects);

    this.isInitialized = false;
  }

  _createClass(BillEffects, [{
    key: "addTableEffects",
    value: function addTableEffects() {
      var _this = this;

      var tableRows = document.querySelectorAll('.bill-row');
    ...
    value: function addMessageEffects() {
      var messages = document.querySelectorAll('.bill-message');
    ...
    value: function addLogoEffects() {
      ...
      var logo = document.querySelector('.bill-logo');
      if (!logo) return;
    ...
    value: function addRippleStyles() {
      if (!document.getElementById('ripple-styles-bill')) {
        var style = document.createElement('style');
        style.id = 'ripple-styles-bill';
